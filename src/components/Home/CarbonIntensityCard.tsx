    ...
    >
      <div className="flex justify-between items-center mb-2">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-white font-medium text-sm">Carbon Intensity</h3>
        </div>
        ...
        <div className="relative w-52 h-52 flex items-center justify-center shrink-0">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="flex flex-col items-center space-y-1">
              <span className="text-xl text-white font-bold">95gm</span>
              <span className="text-[8px] text-[#E6EAF5] uppercase tracking-wider font-bold">
                CO2/kWh
              </span>
            </div>
          </div>
